...
using System.Linq;
using UnityRipper;
using UnityRipper.SerializedFiles;
using UnityRipperFull.Exporters;

using Object = UnityRipper.Classes.Object;
using Version = UnityRipper.Version;

namespace UnityRipperFull
{
	public static class Program
	{
		...
		{
			//yield break;
			return collection.FetchAssets().Where(t => t.ClassID == ClassIDType.AudioClip);
		}
